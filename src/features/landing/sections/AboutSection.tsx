  ...
  return (
    <Reveal delay={delay}>
      <div
        ...
        className={`relative group rounded-3xl overflow-hidden shadow-sm cursor-pointer ${item.aspect} focus:outline-none focus:ring-4 focus:ring-[#22c55e]/20 transform-gpu transition-transform duration-500 will-change-transform hover:scale-[1.015] hover:-translate-y-1 hover:shadow-lg focus:scale-[1.015] bg-white ring-1 ring-black/5`}
      >
        {/* Image */}
        <img
          src={item.src}
