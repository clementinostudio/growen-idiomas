...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-white text-gray-600 pt-16 pb-12 transition-colors duration-500">
          ...
          <div className="flex flex-col gap-6 max-w-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="block ml-1 text-[10px] tracking-[0.4em] text-gray-500 font-bold uppercase">
                  Idiomas
                </span>
              </div>
            </div>
